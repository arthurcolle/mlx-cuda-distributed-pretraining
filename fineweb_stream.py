...
from core.training import Trainer, CheckpointManager
...
class FineWebStreamingDataset(IterableDataset):
    ...
    def __init__(self, url_pattern, tokenizer, max_context_size=2048, shuffle_buffer=10000):
    ...
    def __iter__(self):
        ...
        dataset = (
            wds.WebDataset(self.url_pattern)       # Stream from shards
...
def stream_training_loop(config_path, shard_url_pattern, num_workers=4, prefetch_factor=2):
    ...
    with open(log_file, 'w') as log:
        ...
        log.write(f"Streaming from: {shard_url_pattern}\n")
        log.write("=" * 50 + "\n\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--shard-pattern', type=str, required=True, 
                      help='URL pattern for FineWeb shards (e.g., s3://fineweb/shard-{00000..01000}.tar.bz2)')
    ...
    stream_training_loop(
        ...
        shard_url_pattern=args.shard_pattern,
